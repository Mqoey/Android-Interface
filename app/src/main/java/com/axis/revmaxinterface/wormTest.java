...
/**
 * Created by uhayat on 20/07/2017.
 */
...
///////////////////////////////////////////////////
    ...
    public int exportCardDetails(ArrayList<WormEntry> list)
    {
        ...
        while (currentblock < totalNumberOfBlocks)
        {
            ...
            if (currentTransaction.isIncidentReport == true)
            { // ignore incidents
    ...
    public ArrayList<WormEntry> exportWormStores ( ArrayList<WormEntry> list )
    {
        ...
        int currentblock = 0;
        if (list == null){
            //System.out.println("ropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzoropafadzo");
            list = new ArrayList<WormEntry>();
        ...
        public WormEntry(int blockId, Boolean withData) {
         ...
         //   System.out.print("***curentblock " + currentblock+"  ");
            ...
            if (_is32bit==1) {
                ...
                //System.out.println("***Wb" + wormDataLength);
          ...
          //  System.out.println("***1WORMlen "+wormDataLength);
            ...
            if (wormDataLength == 0)
            {
                ...
                transactionBlocks = 1;
              //  System.out.println("***inci"+String.valueOf(transactionBlocks));
            }
            else
            {
              ...
              //  System.out.print("***number of blocks "+String.valueOf(transactionBlocks)+"  ");
            }
            //System.out.println("***WORMlen "+"*** "+wormDataLength);
...
//ReadData();
            ...
            if (withData)
            {
             //   System.out.println("withdatawithdatawithdatawithdatawithdatawithdatawithdata");
                ReadData();
            }
            else
            {
               // System.out.println("nodatasodadatnodatanodata");
                wormData = null;
            }

            nextBlock = currentblock + transactionBlocks;
            //System.out.println("***nextbock"+nextBlock);
        }
