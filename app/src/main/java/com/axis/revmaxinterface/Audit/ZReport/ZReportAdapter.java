...
public class ZReportAdapter extends RecyclerView.Adapter<ZReportAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public ZReportAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =  LayoutInflater.from(context).inflate(R.layout.list_item, parent, false);
        return  new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ZReportAdapter.MyViewHolder holder, int position) {
