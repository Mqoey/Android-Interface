...
import com.axis.revmaxinterface.RevAudit.revAuditActivity;
...
private Connection connection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Intent intent = new Intent("");
        //intent.putExtra("text","bla bla bla");
        //if(intent.resolveActivity(getPackageManager())!=null){
        //    startActivityForResult(intent,1);
       // }


        // startService(new Intent(getBaseContext(), Soap.class));
        ...
        findViewById(R.id.audit).setOnClickListener(new View.OnClickListener() {
            @Override
            public  void onClick(View v) {
          startActivity(new Intent(getBaseContext(), revAuditActivity.class));
            }
        });
...
//                PopupMenu popup = new PopupMenu(MainActivity.this, printerButton);
//                //Inflating the Popup using xml file
//                popup.getMenuInflater().inflate(R.menu.popup_menu, popup.getMenu());
//             //   popup.getMenu().add(groupId, itemId, order, title);
//                popup.getMenu().add(0, 1, 5, "title5");
//                popup.getMenu().add(0, 2, 4, "title4");
...
//            }
//            case 3: {
//                Toast.makeText(getApplicationContext(),"bholato bholato",Toast.LENGTH_LONG).show();
//            }
//
//
//
...
//        }
        ...
        try {
            ...
            try {
                ...
                Toast.makeText(this.getApplicationContext(), "Failed to Create ZReports"+el.getMessage(), Toast.LENGTH_LONG).show();
                return;
            }
        }
